// Package privacy handles ignored users and public relationship summaries.
package privacy
...
func (input Command) CommandName() command.Name { return input.Name }
...
func (handler Handler) Handle(ctx context.Context, input Command) error {
...
func (handler Handler) sendIgnored(ctx context.Context, connection netconn.Context, actorID int64) error {
...
func (handler Handler) ignore(ctx context.Context, input Command, actorID int64) error {
...
func (handler Handler) unignore(ctx context.Context, input Command, actorID int64) error {
...
func (handler Handler) sendRelationships(ctx context.Context, connection netconn.Context, playerID int64) error {

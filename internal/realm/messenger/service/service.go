// Package service coordinates messenger domain behavior.
package service
...
func New(options Options, store repository.Store, players playerservice.Manager, live *playerlive.Registry, rooms *roomlive.Registry, permissions permissionservice.Checker, redisClient *redis.Client, filter *chatfilter.Service, nodes Nodes, messageLog MessageLogger) *Service {

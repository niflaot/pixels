...
import (
	...
	outfind "github.com/niflaot/pixels/networking/outbound/messenger/findroom"
	outfriends "github.com/niflaot/pixels/networking/outbound/messenger/friends"
	outinit "github.com/niflaot/pixels/networking/outbound/messenger/init"
	outrequests "github.com/niflaot/pixels/networking/outbound/messenger/requests"
	outsearch "github.com/niflaot/pixels/networking/outbound/messenger/search"
...
func (handler Handler) HandleProfile(ctx context.Context, input ProfileCommand) error {
	...
	packet, err := outprofile.Encode(profile.Record.Player.ID, profile.Record.Player.Username, profile.Record.Profile.Look,
		profile.Record.Profile.Motto, registration, int32(profile.FriendCount), profile.IsFriend, profile.RequestSent,

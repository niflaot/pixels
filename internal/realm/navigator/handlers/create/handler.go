...
import (
	...
	increate "github.com/niflaot/pixels/networking/inbound/navigator/create"
	"go.uber.org/zap"
)

// New creates a navigator room creation packet handler.
func New(handler createcmd.Handler, log *zap.Logger) netconn.Handler {
	...
	return func(connection netconn.Context, packet codec.Packet) error {
		...
		return dispatcher.Dispatch(context.Background(), command.Envelope[createcmd.Command]{
...
func createCommand(connection netconn.Context, payload increate.Payload) createcmd.Command {

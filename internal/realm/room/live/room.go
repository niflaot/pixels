...
import (
	...
	roomowner "github.com/niflaot/pixels/internal/realm/room/live/owner"
	rightsstate "github.com/niflaot/pixels/internal/realm/room/rights/state"
...
func (room *Room) startLoop(ctx context.Context, interval time.Duration, movementPublisher MovementPublisher, doorbellPublisher DoorbellPublisher, doorbellTimeout time.Duration) {
	if movementPublisher == nil && doorbellPublisher == nil {
		return
	}

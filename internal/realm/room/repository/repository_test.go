...
func roomValuesForTest() []any {
	...
	return []any{int64(9), int64(7), "demo", "Test Room", "hello", "model_a", int16(roommodel.DoorModeOpen), pgtype.Text{String: "bcrypt-hash", Valid: true}, 25, 3, pgtype.Int8{}, int16(roommodel.TradeModeDisabled), false, true, false, false, 0, 0, int16(0), int16(1), int16(1), int16(50), int16(2), false, false, now, now, pgtype.Timestamptz{}, int64(1)}
}

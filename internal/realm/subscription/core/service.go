...
func New(options Options, store record.Store, players playerservice.ClubWriter, currencies currencyservice.Granter, furniture furnitureservice.DefinitionGranter, catalog Catalog, events bus.Publisher, live ...*playerlive.Registry) *Service {
